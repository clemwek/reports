...
class Accident extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'rep_id', 'staff_id', 'dosh_id', 'nature_of_injury', 'body_part_injury', 'extent_of_injury', 'description', 'first_aid', 'hospital', 'first_aid_explain', 'hospital_explain', 'coment');
	...
	public static function make ($rep_id, $staff_id, $dosh_id, $nature_of_injury, $body_part_injury, $extent_of_injury, $description, $first_aid, $hospital, $first_aid_explain, $hospital_explain, $coment) {
		$accident = new Accident;

		$accident->id =(INT) 0;
		$accident->rep_id = $rep_id;
